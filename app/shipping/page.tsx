...
export default function ShippingPage() {
  return (
    <div className="pt-32 pb-24 bg-primary-foreground">
      <div className="regime-container max-w-5xl">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="regime-section-title mb-8 font-mono font-bold">Shipping & Returns Policy</h1>
